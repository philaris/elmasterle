...
describe('Update keyboard clue map', () => {
    ...
    test('Misplaced does not change exact', () => {
        const map1 = new Map<string, ClueLetter>([
            ['Π', 'e'], ['Α', 'm'], ['Κ', 'a'], ['Ο', 'a'], ['Σ', 'm']
        ])
